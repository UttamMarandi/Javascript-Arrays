...
// callback() is called the reducer method
...
let sum = numbers.reduce(function (passedIn, item) {
  //passedIn is the inital value that also act as "processing" variable and item is each element of the array
  //also called accumulator which intially is the intial value here it is  0. item is each element of the array.
...
// less than (<) also works for strings: alphabatical comparision

// important thing about reducer function is that it will return a value. and that value becomes the accumulator for the next iteration

console.log("first movie", firstMovie);

let sortMovies = movies.sort();
console.log("first movie using sort ", sortMovies[0]);
