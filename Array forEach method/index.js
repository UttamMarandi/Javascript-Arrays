...
let tuts = ["charlie" , "hugh", "Daniels", "Patience","shane", "Leonard", "june", "freeman", "otis", "jarvis", "lane"]
...
tuts.forEach(function(tut , tusk, array){ //tut is each element , tusk is the index no and array is the entire array
    tut =  tut.toUpperCase()
    console.log(tut);
})