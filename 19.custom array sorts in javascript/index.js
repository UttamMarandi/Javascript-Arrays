...
let sortedNum = numbers.sort(function(a,b){ //here a,b are not converted to strings. the actual numerical value is passed\
...
let sortPeople = people.sort(function(a,b){ //a,b represents single object within the array
    if(a.name > b.name) return 1 //a.name because we are sorting based on name label
...
let sortPeoplebyId = people.sort(function(a,b){ //a,b represents single object within the array
