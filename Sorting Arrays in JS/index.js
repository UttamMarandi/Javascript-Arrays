...
characters = ["Iron Man" , "Hulk", "Spiderman", "Ant Man"]
console.log("splice() with three paramters ", characters.splice(0,2 ,"Anakin"));
...
characters = ["Iron Man" , "Hulk", "Spiderman", "Ant Man"]
console.log("slice() passing a string as parameter", characters.splice("black widow"));
//returns all 4 elemets..that means character now has only one element i.e black widow and all other elements are removed (Wrong ..array is empty noe)
